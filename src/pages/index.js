...
import ImageSlider from "@/components/catalog";
    ...
    <>
      ...
      <>
        ...
        <div className="z-50" style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", color: "#fff", width: "300px" }}>
            <h1 className="text-sm uppercase font-bld">We are building the largest footwear catalog <br /> in Ghana.</h1>
            <h1 className="text-xl uppercase font-bold my-2">Enjoy 30% discount on your first purchase.</h1>

            {!submitted ? <div className="animate-bounce flex justify-center w-full mt-4">
            ...
            {!submitted ? <form
              ...
              <button type="submit" className="w-full bg-blue-600 text-white p-2 capitalize text-sm font-medium mt-2 ">
                Get early access
              </button>
